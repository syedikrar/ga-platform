                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <ul class="link-list-opt no-bdr">
                                            <li><a href="javascript:void(0);" data-act="ajax-modal" data-complete-location="true" data-method="get" data-action-url="{{ route('dashboard.stages.create') }}" data-table="stages-table" data-title="ADD NEW COHORT stage">
                                                <img src="{{ asset('images/dashboard/dot-icon1.png')}}" alt=""><span>ADD COHORT STAGE</span></a>
                                            </li>
                                ...
                                <div class="nk-block nk-block-lg bg-white">
                                    <div class="card bg-white">
                                        <div class="table-content table">
                                            ...
                                            <table class="nowrap nk-tb-list nk-tb-ulist table" id="stages" data-export-title="Export">
                                                <thead>
                                                    <tr class="nk-tb-item nk-tb-head">
                                                        <th><input type="checkbox" class="select-checkbox"></th>
                                                        <th class="nk-tb-col">
                                                            <div class="dropdown">
                                                                <a class="dropdown-toggle btn btn-icon btn-trigger" data-toggle="dropdown" aria-expanded="false">Cohort Stage Name English <em class="icon ni ni-caret-down-fill"></em></a>
                                                        ...
                                                        <th class="nk-tb-col tb-col-mb">
                                                            <div class="dropdown">
                                                                <a class="dropdown-toggle btn btn-icon btn-trigger" data-toggle="dropdown" aria-expanded="false">Cohort Stage Name Arabic</a>
    ...
    <script>
        $(function() {
          var table =  $('#stages').DataTable({
                ajax: '{{ route("dashboard.stages.datatable") }}',
                select: {
                    style: 'multi',
                ...
                columns: [
                   {    targets: 0,
                    ...
                    {data: 'actions', name: 'actions', orderable: false, searchable: false, sClass:"nk-tb-col",  sWidth: '30%'},
                ],
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    $(nRow).addClass('nk-tb-item');
                    $('#stages_info').parents('.col-md-5').css({'order':'2', 'text-align':'right'});
                    $('#stages_paginate').parents('.col-md-7').css('order','1');
                }
            });
