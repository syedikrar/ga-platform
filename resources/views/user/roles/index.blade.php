                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul class="nav nav-tabs mt-n3 justify-content-start m-3">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link filter-sector" data-sector="Government" data-toggle="tab" href="#tabItem4">Entity Users</a>
                                        </li>
                                        <li class="nav-item">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="javascript:void(0);" data-act="ajax-modal" data-complete-location="true" data-method="get" data-action-url="{{ route('dashboard.user.create') }}" data-table="entities-table" data-title="Add Admin">
                                                            <img src="{{ asset('images/dashboard/dot-icon1.png')}}" alt=""><span>Add Admin</span></a>
                                                        </li>
