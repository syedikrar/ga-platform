<form method="POST" action="{{ url('dashboard/user/store_user') }}" id="entities_table" enctype="multipart/form-data"
        ...
        <div class="modal-header align-center">
            <div class="nk-file-title">
                ...
                <div class="nk-file-name">
                    <div class="nk-file-name-text"><span class="title">Add Admin</span></div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="single-form-field single-form-row">
                        ...
                        <select class="form-select-2 form-control form-select-modal" data-search="on" name="role" id="inputGroupSelect02">
