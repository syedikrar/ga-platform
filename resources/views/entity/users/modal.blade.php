...
$url = $isEdit ? route('dashboard.user.update', $user->id) : route('dashboard.user.store');
@endphp
<form enctype="multipart/form-data" method="post" action="{{ $url }}" id="entities_users_table" data-form="ajax-form" data-datatable="#entities_users_table" data-modal="#ajax_model" data-form-reset="true">
    @csrf
    @if($isEdit == false)
        ...
        <div class="modal-header align-center">
            <div class="nk-file-title">
                ...
                <div class="nk-file-name">
                    <div class="nk-file-name-text"><span class="title">{{ $isEdit ? 'EDIT' : 'ADD' }} USER</span></div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="single-form-field single-form-row">
                        ...
                        <input type="text" placeholder="Name In English" name="name_en" value="{{ $isEdit ? $user->name_en : '' }}" required>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="single-form-field single-form-row">
                        <label><span>*</span> Name In Arabic</label>
                        <input type="text" placeholder="Name In Arabic" name="name_ar" value="{{ $isEdit ? $user->name_ar : '' }}" required>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="single-form-field single-form-row">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text">+971</span></div><input type="text" class="form-control" placeholder="XXXXXXXXX" name="phone" value="{{ $isEdit ? $user->phone : '' }}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="single-form-field single-form-row">
                        ...
                        <input type="text" placeholder="Email" name="email" value="{{ $isEdit ? $user->email : '' }}" required>
                    </div>
                </div>
