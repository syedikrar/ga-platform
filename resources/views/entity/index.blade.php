                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul class="nav nav-tabs mt-n3 justify-content-start m-3">
                                        <li class="nav-item">
                                            <a class="nav-link active filter-sector"  data-sector="" data-toggle="tab" href="#tabItem1">ALL</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link filter-sector" data-sector="Government" data-toggle="tab" href="#tabItem4">GOVERNMENT</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link filter-sector" data-sector="Private Sector" data-toggle="tab" href="#tabItem5">PRIVATE SECTOR</a>
                                        </li>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="javascript:void(0);" data-act="ajax-modal" data-complete-location="true" data-method="get" data-action-url="{{ route('dashboard.entities.create') }}" data-table="entities-table" data-title="Add Entity">
                                                            <img src="{{ asset('images/dashboard/dot-icon1.png')}}" alt=""><span>Add Entity</span></a>
                                                        </li>
                                                       <!-- <li><a href="#file-copy" data-toggle="modal"><img src="{{ asset('images/dashboard/dot-icon2.png')}}" alt=""><span>UPLOAD BULK SHEET</span></a></li>
                                                        <li><a href="#file-move" data-toggle="modal"><img src="{{ asset('images/dashboard/dot-icon3.png')}}" alt=""><span>DOWNLOAD BULK TEMPLATE</span></a></li>
                                                        <li><a href="#" class="file-dl-toast"><img src="{{ asset('images/dashboard/dot-icon4.png')}}" alt=""><span>EXPORT ENTITY</span></a></li>
                                                        <li><a href="#"><img src="{{ asset('images/dashboard/dot-icon5.png')}}" alt=""><span>EXPORT REPORT IN ENGLISH</span></a></li>
                                                        <li><a href="#"><img src="{{ asset('images/dashboard/dot-icon6.png')}}" alt=""><span>EXPORT REPORT IN ARABIC</span></a></li>-->
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="nk-block nk-block-lg bg-white">
                                            <div class="card bg-white">
                                                <div class="table-content table">
                                                        ...
                                                        <div class="row gy-2">
                                                            ...
                                                            <div class="col-lg-5 col-sm-6">
                                                                <div class="form-group selectSearch text-right">
                                                                    <div class="dropdown">
                                                                        <a class="text-soft dropdown-toggle btn btn-icon btn-trigger hover-hidden text-left filter-container" data-toggle="dropdown" aria-expanded="false">
                                                                            <span class="selected-filters">
                                                                                Filter by Entity Types
                                                                            </span>
                                                                                <em class="icon ni ni-caret-down-fill position-absolute right-0" ></em>
                                                                        </a>
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right dropdown-menu-s1">
                                                                            <div class="dropdown-body">
                                                                                ...
                                                                                <div class="nk-notification filter-container-dropdown">
                                                    ...
                                                    <table class="nk-tb-list nk-tb-ulist table" id="entities-table" data-export-title="Export">
                                                        <thead>
    ...
    <script>
        $(function() {
            ...
            var table =  $('#entities-table').DataTable({
                ajax: {
                    url: '{{ route("dashboard.entities.datatable") }}',
                    cache: false,
                    "data": function ( d ) {
                        d.filter_type = types;
                        d.sector = sector;
                ...
                columns: [
                   {    targets: 0,
                    ...
                    {data: 'name', name: 'name_en', sClass:"nk-tb-col", sWidth:'30%',},
                    {data: 'entityType', name: 'entityType.name_en', sClass:"nk-tb-col", sWidth:'15%',},
                    {data: 'short_name', name: 'short_name', sClass:"nk-tb-col", sWidth:'15%',},
                    {data: 'challenges', name: 'challenges', sClass:"nk-tb-col",searchable: false, sWidth:'15%',},
                    {data: 'users', name: 'users', sClass:"nk-tb-col", searchable: false, sWidth:'10%',},
                    {data: 'actions', name: 'actions', orderable: false, searchable: false, sClass:"nk-tb-col", sWidth:'10%',},
                ],
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    $(nRow).addClass('nk-tb-item');
                    $('#entities-table_info').parents('.col-md-5').css({'order':'2', 'text-align':'right'});
                    $('#entities-table_paginate').parents('.col-md-7').css('order','1');
                }
            });
