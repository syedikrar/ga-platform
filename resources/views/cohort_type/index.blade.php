                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <ul class="link-list-opt no-bdr">
                                            <li><a href="javascript:void(0);" data-act="ajax-modal" data-complete-location="true" data-method="get" data-action-url="{{ route('dashboard.cohort-types.create') }}" data-table="cohort-types-table" data-title="ADD NEW COHORT TYPE">
                                                <img src="{{ asset('images/dashboard/dot-icon1.png')}}" alt=""><span>Add Cohort Methodology</span></a>
                                            </li>
                                ...
                                <div class="nk-block nk-block-lg bg-white">
                                    <div class="card bg-white">
                                        <div class="table-content table">
                                            ...
                                            <table class="nowrap nk-tb-list nk-tb-ulist table" id="cohort-types" data-export-title="Export">
                                                <thead>
                                                    <tr class="nk-tb-item nk-tb-head">
                                                        <th><input type="checkbox" class="select-checkbox"></th>
                                                        <th class="nk-tb-col">
                                                            <div class="dropdown">
                                                                <a class="dropdown-toggle btn btn-icon btn-trigger" data-toggle="dropdown" aria-expanded="false">Cohort Methodology Name English <em class="icon ni ni-caret-down-fill"></em></a>
                                                        ...
                                                        <th class="nk-tb-col tb-col-mb">
                                                            <div class="dropdown">
                                                                <a class="dropdown-toggle btn btn-icon btn-trigger" data-toggle="dropdown" aria-expanded="false">Cohort Methodology Name Arabic</a>
...
@push('scripts')
    ...
    <script>
        $(function() {
          var table =  $('#cohort-types').DataTable({
                ajax: '{{ route("dashboard.cohort-types.datatable") }}',
                processing: true,
                select: {
                    style: 'multi',
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    ...
                    $('#cohort-types_info').parents('.col-md-5').css({'order':'2', 'text-align':'right'});
                    $('#cohort-types_paginate').parents('.col-md-7').css('order','1');
                }
            });
